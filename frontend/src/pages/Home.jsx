  ...
  return (
    <div className="space-y-6 px-6 py-4 pb-8 dark:bg-gray-900 ">
      <div className="flex flex-col md:flex-row justify-between items-start gap-6 px-6 py-4">
        <div className="flex-1 max-w-[700px]">
          ...
          <p className="text-gray-600 text-[20px] leading-relaxed dark:text-gray-400">
            ...
            perlindungan maksimal terhadap pemalsuan dan manipulasi sertifikat.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <CardStat
          icon={<Icon name="document" className="h-[44px] text-blue-dark dark:text-blue-light" />}
          label="Sertifikat Terbit"
          value={130}
        />
        <CardStat
          icon={
            <Icon name="document_verified" className="h-[44px] text-blue-dark dark:text-blue-light" />
          }
